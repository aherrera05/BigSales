...
import { Image, StyleSheet, View, Text,Dimensions, TouchableOpacity, PanResponder, Animated } from 'react-native'
    ...
    onPanResponderRelease: (e, state) => {
     if(Math.abs(state.dx) > width * 0.4){
        ...
        Animated.timing(imageXPos,{
          ...
          console.log('image',Object.values(dealDetail.media)[imageIndex 
          + direction * -1])
          if(Object.values(dealDetail.media)[imageIndex 
            + direction * -1]){
